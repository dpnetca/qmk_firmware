...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
            ...
            KC_LBRC, KC_Z, KC_X, KC_C, KC_V, KC_B,            KC_INS,           KC_APP,   KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RBRC,
                     LT(5,KC_ESC), LT(4,KC_BSPC), LT(1,KC_DEL),                   LT(3,KC_SPC), KC_ENT, LT(2,KC_TAB)
        ),
    [1] = LAYOUT(
            TG(6), KC_NO, KC_NO, KC_NO, KC_NO, KC_HOME,                                   KC_LPRN, KC_NUM, KC_PSLS, KC_PAST, KC_PMNS, KC_PAUS,
            KC_NO, KC_NO, KC_NO, KC_UP, KC_NO, KC_END,                                    KC_RPRN, KC_P7, KC_P8, KC_P9, KC_PPLS, KC_PSCR,
            KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP,                             KC_PERC, KC_P4, KC_P5, KC_P6, KC_PEQL, KC_SCRL,
            KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PGDN,     KC_NO,             KC_NO,     KC_PCMM, KC_P1, KC_P2, KC_P3, KC_PENT, KC_NO,
                                     KC_NO, KC_TRNS, KC_TRNS,                        KC_P0, KC_PDOT, KC_NO
        ),
    [2] = LAYOUT(
